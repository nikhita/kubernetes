...
func RegisterDefaults(scheme *runtime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&ControllerRevision{}, func(obj interface{}) { SetObjectDefaults_ControllerRevision(obj.(*ControllerRevision)) })
	scheme.AddTypeDefaultingFunc(&ControllerRevisionList{}, func(obj interface{}) { SetObjectDefaults_ControllerRevisionList(obj.(*ControllerRevisionList)) })
...
func SetObjectDefaults_ControllerRevision(in *ControllerRevision) {
	...
	for i := range in.Data.Raw {
		a := &in.Data.Raw[i]
	}
}

func SetObjectDefaults_ControllerRevisionList(in *ControllerRevisionList) {
	for i := range in.Items {
		a := &in.Items[i]
		SetObjectDefaults_ControllerRevision(a)
	}
}
...
func SetObjectDefaults_StatefulSet(in *StatefulSet) {
	...
	for i := range in.Spec.VolumeClaimTemplates {
		...
		for j := range a.Spec.AccessModes {
			b := &a.Spec.AccessModes[j]
		}
		v1.SetDefaults_ResourceList(&a.Status.Capacity)
	}
	if in.Spec.UpdateStrategy.Partition != nil {
	}
}
