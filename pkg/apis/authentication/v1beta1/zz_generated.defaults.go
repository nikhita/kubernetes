...
func RegisterDefaults(scheme *runtime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&TokenReview{}, func(obj interface{}) { SetObjectDefaults_TokenReview(obj.(*TokenReview)) })
	return nil
}

func SetObjectDefaults_TokenReview(in *TokenReview) {
