...
func RegisterDefaults(scheme *runtime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&ImageReview{}, func(obj interface{}) { SetObjectDefaults_ImageReview(obj.(*ImageReview)) })
	return nil
}

func SetObjectDefaults_ImageReview(in *ImageReview) {
