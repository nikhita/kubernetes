...
func RegisterDefaults(scheme *runtime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&StorageClass{}, func(obj interface{}) { SetObjectDefaults_StorageClass(obj.(*StorageClass)) })
	scheme.AddTypeDefaultingFunc(&StorageClassList{}, func(obj interface{}) { SetObjectDefaults_StorageClassList(obj.(*StorageClassList)) })
	return nil
}

func SetObjectDefaults_StorageClass(in *StorageClass) {
...
func SetObjectDefaults_StorageClassList(in *StorageClassList) {
