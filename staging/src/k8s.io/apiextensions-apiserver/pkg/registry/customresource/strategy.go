...
func NewStrategy(typer runtime.ObjectTyper, namespaceScoped bool, kind schema.GroupVersionKind, crd apiextensionsv1beta1.CustomResourceDefinition) CustomResourceDefinitionStorageStrategy {
