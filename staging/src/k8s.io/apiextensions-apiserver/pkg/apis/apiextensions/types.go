...
type CustomResourceDefinitionSpec struct {
	...
	SubResources CustomResourceSubResourceType
}
...
type CustomResourceSubResourceType struct {
	...
	Scale *CustomResourceSubResourceStatus
}
...
type CustomResourceSubResourceScale struct {
	...
	SpecReplicasPath jsonpath.JSONPath
	// optional, e.g. “.status.replicas”
	StatusReplicasPath jsonpath.JSONPath
	// optional, e.g. “.spec.labelSelector”
	SelectorPath jsonpath.JSONPath
}
