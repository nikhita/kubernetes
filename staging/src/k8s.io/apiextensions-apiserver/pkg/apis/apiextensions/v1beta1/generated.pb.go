...
func (m *PatchMetadata) Reset()                    { *m = PatchMetadata{} }
func (*PatchMetadata) ProtoMessage()               {}
func (*PatchMetadata) Descriptor() ([]byte, []int) { return fileDescriptorGenerated, []int{13} }
...
func init() {
	...
	proto.RegisterType((*PatchMetadata)(nil), "k8s.io.apiextensions_apiserver.pkg.apis.apiextensions.v1beta1.PatchMetadata")
}
...
func (m *CustomResourceDefinitionSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.StrategicMergePatch) > 0 {
		for _, msg := range m.StrategicMergePatch {
			dAtA[i] = 0x32
			i++
			i = encodeVarintGenerated(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *PatchMetadata) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PatchMetadata) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintGenerated(dAtA, i, uint64(len(m.PatchMergeKey)))
	i += copy(dAtA[i:], m.PatchMergeKey)
	if len(m.PatchStrategies) > 0 {
		for _, s := range m.PatchStrategies {
			dAtA[i] = 0x1a
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *CustomResourceDefinitionSpec) Size() (n int) {
	...
	if len(m.StrategicMergePatch) > 0 {
		for _, e := range m.StrategicMergePatch {
			l = e.Size()
			n += 1 + l + sovGenerated(uint64(l))
		}
	}
...
func (m *PatchMetadata) Size() (n int) {
	var l int
	_ = l
	l = len(m.JSONPath)
	n += 1 + l + sovGenerated(uint64(l))
	l = len(m.PatchMergeKey)
	n += 1 + l + sovGenerated(uint64(l))
	if len(m.PatchStrategies) > 0 {
		for _, s := range m.PatchStrategies {
			l = len(s)
...
func (this *CustomResourceDefinitionSpec) String() string {
	...
	s := strings.Join([]string{`&CustomResourceDefinitionSpec{`,
		...
		`StrategicMergePatch:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.StrategicMergePatch), "PatchMetadata", "PatchMetadata", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *PatchMetadata) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PatchMetadata{`,
		`JSONPath:` + fmt.Sprintf("%v", this.JSONPath) + `,`,
		`PatchMergeKey:` + fmt.Sprintf("%v", this.PatchMergeKey) + `,`,
		`PatchStrategies:` + fmt.Sprintf("%v", this.PatchStrategies) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *CustomResourceDefinitionSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StrategicMergePatch", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StrategicMergePatch = append(m.StrategicMergePatch, PatchMetadata{})
			if err := m.StrategicMergePatch[len(m.StrategicMergePatch)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *PatchMetadata) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PatchMetadata: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PatchMetadata: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PatchMergeKey", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PatchMergeKey = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PatchStrategies", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PatchStrategies = append(m.PatchStrategies, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGenerated(dAtA[iNdEx:])
...
var fileDescriptorGenerated = []byte{
	...
	,
}
