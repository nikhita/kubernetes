...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1beta1_JSONSchemaRef_To_apiextensions_JSONSchemaRef,
		Convert_apiextensions_JSONSchemaRef_To_v1beta1_JSONSchemaRef,
	)
}
...
func autoConvert_v1beta1_JSONSchemaProps_To_apiextensions_JSONSchemaProps(in *JSONSchemaProps, out *apiextensions.JSONSchemaProps, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_JSONSchemaRef_To_apiextensions_JSONSchemaRef(&in.Ref, &out.Ref, s); err != nil {
		return err
	}
...
func autoConvert_apiextensions_JSONSchemaProps_To_v1beta1_JSONSchemaProps(in *apiextensions.JSONSchemaProps, out *JSONSchemaProps, s conversion.Scope) error {
	...
	if err := Convert_apiextensions_JSONSchemaRef_To_v1beta1_JSONSchemaRef(&in.Ref, &out.Ref, s); err != nil {
		return err
	}
	out.Description = in.Description
...
func autoConvert_v1beta1_JSONSchemaRef_To_apiextensions_JSONSchemaRef(in *JSONSchemaRef, out *apiextensions.JSONSchemaRef, s conversion.Scope) error {
	out.ReferenceURL = (*url.URL)(unsafe.Pointer(in.ReferenceURL))
	if err := Convert_v1beta1_JSONSchemaPointer_To_apiextensions_JSONSchemaPointer(&in.ReferencePointer, &out.ReferencePointer, s); err != nil {
		return err
	}
...
// Convert_v1beta1_JSONSchemaRef_To_apiextensions_JSONSchemaRef is an autogenerated conversion function.
func Convert_v1beta1_JSONSchemaRef_To_apiextensions_JSONSchemaRef(in *JSONSchemaRef, out *apiextensions.JSONSchemaRef, s conversion.Scope) error {
	return autoConvert_v1beta1_JSONSchemaRef_To_apiextensions_JSONSchemaRef(in, out, s)
}

func autoConvert_apiextensions_JSONSchemaRef_To_v1beta1_JSONSchemaRef(in *apiextensions.JSONSchemaRef, out *JSONSchemaRef, s conversion.Scope) error {
	out.ReferenceURL = (*url.URL)(unsafe.Pointer(in.ReferenceURL))
	if err := Convert_apiextensions_JSONSchemaPointer_To_v1beta1_JSONSchemaPointer(&in.ReferencePointer, &out.ReferencePointer, s); err != nil {
		return err
	}
	out.HasFullURL = in.HasFullURL
	out.HasURLPathOnly = in.HasURLPathOnly
...
// Convert_apiextensions_JSONSchemaRef_To_v1beta1_JSONSchemaRef is an autogenerated conversion function.
func Convert_apiextensions_JSONSchemaRef_To_v1beta1_JSONSchemaRef(in *apiextensions.JSONSchemaRef, out *JSONSchemaRef, s conversion.Scope) error {
	return autoConvert_apiextensions_JSONSchemaRef_To_v1beta1_JSONSchemaRef(in, out, s)
}
