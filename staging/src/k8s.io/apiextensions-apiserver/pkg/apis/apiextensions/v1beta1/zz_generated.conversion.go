...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1beta1_CustomResourceSubResourceType_To_apiextensions_CustomResourceSubResourceType,
		Convert_apiextensions_CustomResourceSubResourceType_To_v1beta1_CustomResourceSubResourceType,
...
func autoConvert_v1beta1_CustomResourceDefinitionSpec_To_apiextensions_CustomResourceDefinitionSpec(in *CustomResourceDefinitionSpec, out *apiextensions.CustomResourceDefinitionSpec, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_CustomResourceSubResourceType_To_apiextensions_CustomResourceSubResourceType(&in.SubResources, &out.SubResources, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1beta1_CustomResourceSubResourceType_To_apiextensions_CustomResourceSubResourceType(in *CustomResourceSubResourceType, out *apiextensions.CustomResourceSubResourceType, s conversion.Scope) error {
	out.Status = (*apiextensions.CustomResourceSubResourceStatus)(unsafe.Pointer(in.Status))
	out.Scale = (*apiextensions.CustomResourceSubResourceStatus)(unsafe.Pointer(in.Scale))
	return nil
}

// Convert_v1beta1_CustomResourceSubResourceType_To_apiextensions_CustomResourceSubResourceType is an autogenerated conversion function.
func Convert_v1beta1_CustomResourceSubResourceType_To_apiextensions_CustomResourceSubResourceType(in *CustomResourceSubResourceType, out *apiextensions.CustomResourceSubResourceType, s conversion.Scope) error {
	return autoConvert_v1beta1_CustomResourceSubResourceType_To_apiextensions_CustomResourceSubResourceType(in, out, s)
}

func autoConvert_apiextensions_CustomResourceSubResourceType_To_v1beta1_CustomResourceSubResourceType(in *apiextensions.CustomResourceSubResourceType, out *CustomResourceSubResourceType, s conversion.Scope) error {
	out.Status = (*CustomResourceSubResourceStatus)(unsafe.Pointer(in.Status))
	out.Scale = (*CustomResourceSubResourceStatus)(unsafe.Pointer(in.Scale))
	return nil
}

// Convert_apiextensions_CustomResourceSubResourceType_To_v1beta1_CustomResourceSubResourceType is an autogenerated conversion function.
func Convert_apiextensions_CustomResourceSubResourceType_To_v1beta1_CustomResourceSubResourceType(in *apiextensions.CustomResourceSubResourceType, out *CustomResourceSubResourceType, s conversion.Scope) error {
	return autoConvert_apiextensions_CustomResourceSubResourceType_To_v1beta1_CustomResourceSubResourceType(in, out, s)
}
