...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1beta1_PatchMetadata_To_apiextensions_PatchMetadata,
		Convert_apiextensions_PatchMetadata_To_v1beta1_PatchMetadata,
	)
}
...
func autoConvert_v1beta1_CustomResourceDefinitionSpec_To_apiextensions_CustomResourceDefinitionSpec(in *CustomResourceDefinitionSpec, out *apiextensions.CustomResourceDefinitionSpec, s conversion.Scope) error {
	...
	out.StrategicMergePatch = *(*[]apiextensions.PatchMetadata)(unsafe.Pointer(&in.StrategicMergePatch))
	return nil
}
...
func autoConvert_apiextensions_CustomResourceDefinitionSpec_To_v1beta1_CustomResourceDefinitionSpec(in *apiextensions.CustomResourceDefinitionSpec, out *CustomResourceDefinitionSpec, s conversion.Scope) error {
	...
	out.StrategicMergePatch = *(*[]PatchMetadata)(unsafe.Pointer(&in.StrategicMergePatch))
	return nil
}
...
func autoConvert_v1beta1_PatchMetadata_To_apiextensions_PatchMetadata(in *PatchMetadata, out *apiextensions.PatchMetadata, s conversion.Scope) error {
	out.JSONPath = in.JSONPath
	out.PatchMergeKey = in.PatchMergeKey
	out.PatchStrategies = *(*[]string)(unsafe.Pointer(&in.PatchStrategies))
	return nil
}

// Convert_v1beta1_PatchMetadata_To_apiextensions_PatchMetadata is an autogenerated conversion function.
func Convert_v1beta1_PatchMetadata_To_apiextensions_PatchMetadata(in *PatchMetadata, out *apiextensions.PatchMetadata, s conversion.Scope) error {
	return autoConvert_v1beta1_PatchMetadata_To_apiextensions_PatchMetadata(in, out, s)
}

func autoConvert_apiextensions_PatchMetadata_To_v1beta1_PatchMetadata(in *apiextensions.PatchMetadata, out *PatchMetadata, s conversion.Scope) error {
	out.JSONPath = in.JSONPath
	out.PatchMergeKey = in.PatchMergeKey
	out.PatchStrategies = *(*[]string)(unsafe.Pointer(&in.PatchStrategies))
	return nil
...
// Convert_apiextensions_PatchMetadata_To_v1beta1_PatchMetadata is an autogenerated conversion function.
func Convert_apiextensions_PatchMetadata_To_v1beta1_PatchMetadata(in *apiextensions.PatchMetadata, out *PatchMetadata, s conversion.Scope) error {
	return autoConvert_apiextensions_PatchMetadata_To_v1beta1_PatchMetadata(in, out, s)
}
